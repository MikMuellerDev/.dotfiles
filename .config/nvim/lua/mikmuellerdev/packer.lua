...
return require('packer').startup {
    function(use)
        ...
        use {
            {
                ...
                config = function() require('mikmuellerdev.plugin.autopairs') end,
            },
        ...
        use {
            ...
            config = function() require('mikmuellerdev.plugin.lualine') end,
        }
        use {
        ...
        use {
            ...
            config = function() require('mikmuellerdev.plugin.telescope') end,
        }
        ...
        use {
            ...
            config = function() require('mikmuellerdev.plugin.goto_preview') end,
        }
        use {
            'weilbith/nvim-code-action-menu',
            config = function() require('mikmuellerdev.plugin.code_action_menu') end,
        }
        ...
        use {
            ...
            config = function() require('mikmuellerdev.plugin.cmp') end,
        }
        ...
        use {
            ...
            config = function() require('mikmuellerdev.plugin.gitsigns') end,
        }
